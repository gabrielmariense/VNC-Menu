...
def prune_window_geometries(settings: dict) -> int:
    ...
    if removed:
        ...
        # traria de volta justamente as chaves orfas que acabaram de sair.
...
def save_window_geometry(win, key: str):
    ...
    try:
        ...
        # False: este E o escritor de geometria. Reler do disco aqui
        # descartaria a geometria que acabou de ser medida.
        save_settings(settings, keep_disk_geometry=False)
