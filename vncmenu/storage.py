...
def _write_creds_file(updates: dict) -> None:
    ...
    Only the UltraVNC credential lives here today, but the merge stays: writing
    the whole dict would make one writer erase any other key kept in the file,
    and the user would only discover it the next time that key was needed.
    """
